...
int main(int argc, char* argv[]) {
  ...
  struct option options[] = {
      {"input-width", required_argument, 0, OPTION_INPUT_WIDTH},
      {"input-height", required_argument, 0, OPTION_INPUT_HEIGHT},
      {"warm-up-iterations", required_argument, 0, OPTION_WARM_UP_ITERATIONS},
      {"max-benchmark-iterations", required_argument, 0,
       OPTION_MAX_BENCHMARK_ITERATIONS},
      {"max-benchmark-duration", required_argument, 0,
       OPTION_MAX_BENCHMARK_DURATION},
      {"single-threaded", no_argument, 0, OPTION_SINGLE_THREADED},
